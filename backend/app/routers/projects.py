...
DEMO_EXCELS = [
    {
        ...
        "description": "10 graphs, single node/edge type, graph_regression target (target_delay)",
        "filename": "demo_multigraph_homo.xlsx",
    ...
    },
    {
        ...
        "description": "10 graphs, 3 node types (cell/pin/net), 3 edge types, graph_regression target (total_wirelength)",
        "filename": "demo_multigraph_hetero.xlsx",
